...
const Int_t n_canvases_for_histos {19};
...
void fit_test5_2(const Int_t run_number_int = 11590, Double_t analyzeOnTrackOrNot = 1, Int_t nevents_display = 10, const TString output_file_name = "output_with_fits.pdf")
{
	...
	TH2F* h2_t0CorrectedvsTrigTime = new TH2F("h2_t0CorrectedvsTrigTime","t0 Corrected and Trigger Time correlation - 2,3,4,5 ts peaking, no shape cut; BBCal Trigger Time (ns); t0 (ns)",100,320,420,100,-50,50);
	...
	for(Long64_t nevent = 0; nevent < nevents; ++nevent)
	{
		...
		for(Int_t ientry = 0; ientry < ndata_stripADCsamples; ientry += ntimesamples)
		{
			...
			fill_histos_noDeconvolution(fitfunction,bbcal_trigtime,h1_maxADC,h1_t0,h1_tau,h1_t0_minus_trigtime,h2_t0vsTrigTime,h1_ADCweightedTime,h1_ADCweightedTime_minus_t0,h2_ADCweightedTimevsTrigTime,h2_t0vsADCweightedTime,h1_t0_minus_correctionTimesTrigTime,h2_t0CorrectedvsTrigTime);
	...
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[14],h1_deconv_maxTS,h1_deconv_maxTS_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[15],h1_deconv_maxTS_ADCbiggerthan50,h1_deconv_maxTS_ADCbiggerthan50_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[16],h1_deconv_maxTS_ADCbiggerthan300,h1_deconv_maxTS_ADCbiggerthan300_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[17],h1_deconv_maxADC,h1_deconv_maxADC_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[18],h1_deconv_ADCweightedTime,h1_deconv_ADCweightedTime_goodshape);
