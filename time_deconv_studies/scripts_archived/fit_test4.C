...
void fill_ADCweighted_time_histos(Double_t maxTS,TH1F* h1_ADCweightedTime_TS2_peakingevnts,TH1F* h1_ADCweightedTime_TS3_peakingevnts,TH1F* h1_ADCweightedTime_TS4_peakingevnts,TH1F* h1_ADCweightedTime_TS5_peakingevnts)
{
	if (maxTS==1) h1_ADCweightedTime_TS2_peakingevnts->Fill(adc_weighted_time);
	else if (maxTS==2) h1_ADCweightedTime_TS3_peakingevnts->Fill(adc_weighted_time);
	else if (maxTS==3) h1_ADCweightedTime_TS4_peakingevnts->Fill(adc_weighted_time);
	else if (maxTS==4) h1_ADCweightedTime_TS5_peakingevnts->Fill(adc_weighted_time);
}

Double_t correction_slope {0.24};
Double_t correction_intercept {-87.26};
void fill_histos_noDeconvolution(TF1* fitfunction, Double_t bbcal_trigtime, TH1F* h1_maxADC, TH1F* h1_t0, TH1F* h1_tau, TH1F* h1_t0_minus_trigtime, TH2F* h2_t0vsTrigTime, TH1F* h1_ADCweightedTime, TH1F* h1_ADCweightedTime_minus_t0, TH2F* h2_ADCweightedTimevsTrigTime, TH2F* h2_t0vsADCweightedTime,TH1F* h1_t0_minus_correctionTimesTrigTime)
{	
	...
	h2_t0vsADCweightedTime->Fill(adc_weighted_time,t0);
 	h1_t0_minus_correctionTimesTrigTime->Fill(t0-(correction_slope*bbcal_trigtime+correction_intercept));
	//h1_t0_minus_correctionTimesTrigTime->Fill(t0);
}
...
const Int_t n_canvases_for_histos {17};
...
void fit_test4(const Int_t run_number_int = 11590, Double_t analyzeOnTrackOrNot = 1, Int_t nevents_display = 10, const TString output_file_name = "output_with_fits.pdf")
{
	...
	TH1F* h1_maxADC = new TH1F("h1_maxADC","Fit Results for maxADCs - 2,3,4,5 ts peaking, no shape cut; ADC",3500,-500,3000); 
	...
	TH1F* h1_t0 = new TH1F("h1_t0","Fit Result for t0 - 2,3,4,5 ts peaking, no shape cut; Time(ns)",400,-100,300);
	TH1F* h1_t0_goodshape = new TH1F("h1_t0_goodshape","Fit Results for t0 - 3,4 ts peaking, with shape cut; Time(ns)",400,-100,300);
	TH1F* h1_tau = new TH1F("h1_tau","Fit Results fotr APV Time Constant tau - 2,3,4,5 ts peaking, no shape cut; Time(ns) ",500,-200,300);
	...
	TH1F* h1_t0_minus_trigtime = new TH1F("h1_t0_minus_trigtime","TriggerTime-t0 : 2,3,4,5 ts peaking, no shape cut ; Time(ns)",700,-100,600);
	...
	TH2F* h2_t0vsTrigTime = new TH2F("h2_t0vsTrigTime","t0 and Trigger Time correlation - 2,3,4,5 ts peaking, no shape cut; BBCal Trigger Time (ns); t0 (ns)",100,320,420,100,-50,50);
	...
	TH1F* h1_t0_minus_correctionTimesTrigTime = new TH1F("h1_t0_minus_correctionTimesTrigTime","t0-CorrectedTrigTime : 2,3,4,5 ts peaking, no shape cut ; Time(ns)",300,-100,200);
	...
	TH1F* h1_ADCweightedTime = new TH1F("h1_ADCweightedTime", "ADC Weighted Time Before Time Deconvolution - 2,3,4,5 ts peaking, no shape cut; Time(ns)",151,0,150);
	...
	TH1F* h1_ADCweightedTime_minus_t0 = new TH1F("h1_ADCweightedTime_minus_t0", "ADCWeightedTime-t0 - 2,3,4,5 ts peaking, no shape cut; Time(ns)",151,0,150);
	...
	TH2F* h2_ADCweightedTimevsTrigTime = new TH2F("h2_ADCweightedTimevsTrigTime","ADC weighted time and Trigger Time correlation - 2,3,4,5 ts peaking, no shape cut; BBCal Trigger Time (ns); ADC weighted time (ns)",100,320,420,151,0,150);
	...
	TH2F* h2_t0vsADCweightedTime = new TH2F("h2_t0vsADCweightedTime","t0 and ADC Weighted Time correlation - 2,3,4,5 ts peaking, no shape cut;ADC weighted time (ns);t0 (ns)",151,0,150,200,-100,100);
	...
	TH1F* h1_deconv_maxTS = new TH1F("h1_deconv_maxTS","Max Time Sample after Time Decon - 2,3,4,5 ts peaking, no shape cut; Time(ns)",6,-0.5,5.5);
	...
	TH1F* h1_deconv_maxADC = new TH1F("h1_deconv_maxADC","Max Time Sample ADC after Time Decon - 2,3,4,5 ts peaking, no shape cut; ADC",3500,-500,3000);
	...
	TH1F* h1_deconv_maxTS_ADCbiggerthan50 = new TH1F("h1_deconv_maxTS_ADCbiggerthan50","Tims Samples with Max ADC > 50 after Time Decon - 2,3,4,5 ts peaking, no shape cut ; Time(ns)",6,-0.5,5.5);
	...
	TH1F* h1_deconv_maxTS_ADCbiggerthan300 = new TH1F("h1_deconv_maxTS_ADCbiggerthan300","Time Samples with Max ADC > 300 after Time Decon -  2,3,4,5 ts peaking, no shape cut; Time(ns)",6,-0.5,5.5);
	...
	TH1F* h1_deconv_ADCweightedTime = new TH1F("h1_deconv_ADCweightedTime","ADC Weighted Time after Time Decon - 2,3,4,5 ts peaking, no shape cut; Time(ns)",151,0,150);
	...
	for(Long64_t nevent = 0; nevent < nevents; ++nevent)
	{
		...
		for(Int_t ientry = 0; ientry < ndata_stripADCsamples; ientry += ntimesamples)
		{
			...
			fill_ADCweighted_time_histos(maxTS,h1_ADCweightedTime_TS2_peakingevnts,h1_ADCweightedTime_TS3_peakingevnts,h1_ADCweightedTime_TS4_peakingevnts,h1_ADCweightedTime_TS5_peakingevnts);
			fill_histos_noDeconvolution(fitfunction,bbcal_trigtime,h1_maxADC,h1_t0,h1_tau,h1_t0_minus_trigtime,h2_t0vsTrigTime,h1_ADCweightedTime,h1_ADCweightedTime_minus_t0,h2_ADCweightedTimevsTrigTime,h2_t0vsADCweightedTime,h1_t0_minus_correctionTimesTrigTime);
			if (sigShape_and_3rdOr4thTS_peaking) fill_histos_noDeconvolution(fitfunction,bbcal_trigtime,h1_maxADC_goodshape,h1_t0_goodshape,h1_tau_goodshape,h1_t0_minus_trigtime_goodshape,h2_t0vsTrigTime_goodshape,h1_ADCweightedTime_goodshape,h1_ADCweightedTime_minus_t0_goodshape,h2_ADCweightedTimevsTrigTime_goodshape,h2_t0vsADCweightedTime_goodshape,h1_t0_minus_correctionTimesTrigTime_goodshape);
	...
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[6],h1_ADCweightedTime,h1_ADCweightedTime_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[7],h1_ADCweightedTime_minus_t0,h1_ADCweightedTime_minus_t0_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[8],h2_ADCweightedTimevsTrigTime,h2_ADCweightedTimevsTrigTime_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[9],h2_t0vsADCweightedTime,h2_t0vsADCweightedTime_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[10],h1_t0_minus_correctionTimesTrigTime,h1_t0_minus_correctionTimesTrigTime_goodshape);
	c_hist[11]->Divide(2,2); 
	c_hist[11]->cd(1); h1_ADCweightedTime_TS2_peakingevnts->Draw();
	c_hist[11]->cd(2); h1_ADCweightedTime_TS3_peakingevnts->Draw();
	c_hist[11]->cd(3); h1_ADCweightedTime_TS4_peakingevnts->Draw();
	c_hist[11]->cd(4); h1_ADCweightedTime_TS5_peakingevnts->Draw();
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[12],h1_deconv_maxTS,h1_deconv_maxTS_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[13],h1_deconv_maxADC,h1_deconv_maxADC_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[14],h1_deconv_maxTS_ADCbiggerthan50,h1_deconv_maxTS_ADCbiggerthan50_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[15],h1_deconv_maxTS_ADCbiggerthan300,h1_deconv_maxTS_ADCbiggerthan300_goodshape);
	divideTheCanvasIntoTwoAndDrawTheHistograms(c_hist[16],h1_deconv_ADCweightedTime,h1_deconv_ADCweightedTime_goodshape);
